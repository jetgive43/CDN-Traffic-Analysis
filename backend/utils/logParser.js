...
function calculateTimeDifference(firstTimestamp, lastTimestamp) {
  ...
  // Debug output
  console.log(`First timestamp: ${firstTimestamp} -> ${firstDate}`);
  console.log(`Last timestamp: ${lastTimestamp} -> ${lastDate}`);
  console.log(`First date valid: ${!isNaN(firstDate.getTime())}`);
  console.log(`Last date valid: ${!isNaN(lastDate.getTime())}`);
